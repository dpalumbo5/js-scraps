...
//Yay-you-figured-it-out!-nice-job-you-win-everything.-Now-try-to-write-the-encoding-function!

const encode = (str) => {
  //split string at each space into array where words are elements => ['put']
  let wordArr = str.split(' ');
  //map? split again so elements are letters => ['p','u','t']
  let letters = wordArr.map((letter) => {
  //convert letters to numbers => [56, 73, 68]
    //how do I make A 12573564632345254 and not 56?
    return letter.charCodeAt();
  })
 return letters.join(' ');
  //convert from array to string of numbers

}

console.log(encode("Put Me Thru is my favorite song by Anderson .Paak"));
